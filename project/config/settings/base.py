...
STORAGES = {
    "default": {
        ...
        'OPTIONS': {
            'access_key': 'AKIAXBO5HDSM27EZU6AB',
            'secret_key': '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',
            'bucket_name': 'chspdfarchive',
            'object_parameters': {
                'CacheControl': 'max-age=86400',
            },
            'file_overwrite': True,
            'region_name': 'us-east-2',
            'custom_domain': 'chspdfarchive.s3.amazonaws.com',
        }
    },
    "archive": {
        "BACKEND": 'storages.backends.s3boto3.S3Boto3Storage',
