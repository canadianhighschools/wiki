...
from apps.core.utils.imports import lazy_import
...
try:
    from settings.renderer import WHITELISTED_TAGS, WHITELISTED_ATTRIBUTES, WHITELISTED_PROTOCOLS, EXTENSIONS, WHITELISTED_CSS_PROPERTIES, WHITELISTED_SVG_PROPERTIES
except ImportError:
