...
class Commit(models.Model):
    ...
    content = models.OneToOneField('core.TextContent', on_delete=models.PROTECT)
    revision = models.ForeignKey('core.Revision', on_delete=models.DO_NOTHING)
    ...
    date_created = models.DateTimeField(auto_now_add=True, auto_created=True, editable=False)
