...
class Page(models.Model):
    ...
    parent = models.OneToOneField('core.Category', on_delete=models.PROTECT, verbose_name="Category")
    date_created = models.DateTimeField(auto_now_add=True, auto_created=True, editable=False, verbose_name="Creation Date")
    date_modified = models.DateTimeField(auto_now=True, auto_created=True, editable=False, verbose_name="Last Modified")
...
class Revision(models.Model):
    ...
    content = models.OneToOneField('core.TextContent', on_delete=models.PROTECT, verbose_name="Text Content")
    page = models.ForeignKey('core.Page', on_delete=models.PROTECT, verbose_name="Page", related_name="revisions")
    date_created = models.DateTimeField(auto_now_add=True, auto_created=True, editable=False, verbose_name="Creation Date")
    date_modified = models.DateTimeField(auto_now=True, auto_created=True, editable=False, verbose_name="Last Modified")
